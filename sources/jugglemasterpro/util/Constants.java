...
import jugglemasterpro.control.util.DefaultRenderer;
...
public class Constants {
	...
	final private static void setFilesNames() {
		...
		Constants.strS_FILE_NAME_A[Constants.intS_FILE_FOLDER_IMAGES] = "images";
		Constants.strS_FILE_NAME_A[Constants.intS_FILE_FOLDER_LIBRARY] = "lib";
		Constants.strS_FILE_NAME_A[Constants.intS_FILE_FOLDER_SOUNDS] = "sounds";
	...
	final private static void setPreferences() {
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_BOOLEAN_GLOBAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_BOOLEAN_GLOBAL_CONTROL_PREFERENCE_A[bytLindex] =
																			Strings.doConcat(	Constants.strS_BOOLEAN_GLOBAL,
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_BOOLEAN_LOCAL_CONTROL_PREFERENCE_A[bytLindex] =
																			Strings.doConcat(	Constants.strS_BOOLEAN_LOCAL,
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_BYTE_GLOBAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_BYTE_GLOBAL_CONTROL_PREFERENCE_A[bytLindex] =
																			Strings.doConcat(	Constants.strS_BYTE_GLOBAL,
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_BYTE_LOCAL_CONTROL_PREFERENCE_A[bytLindex] =
																		Strings.doConcat(	Constants.strS_BYTE_LOCAL,
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_STRING_GLOBAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_STRING_GLOBAL_CONTROL_PREFERENCE_A[bytLindex] =
																			Strings.doConcat(	Constants.strS_STRING_GLOBAL,
		...
		for (byte bytLindex = 0; bytLindex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLindex) {
			Constants.strS_STRING_LOCAL_CONTROL_PREFERENCE_A[bytLindex] =
																			Strings.doConcat(	Constants.strS_STRING_LOCAL,
	...
	final public static KeyStroke				keyS_FIND											=
																										KeyStroke.getKeyStroke(	KeyEvent.VK_F,
																																ActionEvent.CTRL_MASK);
	final public static KeyStroke				keyS_FIND_NEXT										= KeyStroke.getKeyStroke(KeyEvent.VK_F3, 0);
	...
	final public static KeyStroke				keyS_FREE_CLIPBOARD									=
																										KeyStroke.getKeyStroke(	KeyEvent.VK_X,
																																ActionEvent.CTRL_MASK
																																	| ActionEvent.ALT_MASK);
	final public static KeyStroke				keyS_HELP											= KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0);
	...
	final public static KeyStroke				keyS_RELOAD_FILE									=
																										KeyStroke.getKeyStroke(	KeyEvent.VK_F5,
																																ActionEvent.CTRL_MASK);		// +
	final public static KeyStroke				keyS_RELOAD_PATTERN									= KeyStroke.getKeyStroke(KeyEvent.VK_F5, 0);
	...
	final public static Border					objS_GRAPHICS_EMPTY_BORDER							= BorderFactory.createEmptyBorder(0, 0, 0, 0);
	...
	static {
		...
		// Hashmap :
		objS_ENGINE_PARAMETERS_HASH_MAP =
											new HashMap<String, String>(Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER
