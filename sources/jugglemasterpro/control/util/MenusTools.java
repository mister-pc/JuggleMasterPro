...
import jugglemasterpro.control.io.ExtendedMenuComponentObject;
import jugglemasterpro.control.io.PatternsFileJCheckBoxMenuItem;
				...
				if (strLlinkReference != null) {
					switch (intPmenuType) {
						...
						case Constants.intS_FILE_TEXT_LINKS:
							...
							objLnewJMenuItem.setToolTipText(strLlinkReference.replace("%20", Strings.strS_SPACE).replace("%e9", "é"));
							break;
