...
import jugglemasterpro.control.ball.BallsJScrollBar;
import jugglemasterpro.control.ball.BallsThreeStatesJCheckBox;
import jugglemasterpro.control.color.AlternateColorsJCheckBox;
import jugglemasterpro.control.color.AlternateColorsJScrollBar;
import jugglemasterpro.control.color.BallsColorsJTextPane;
import jugglemasterpro.control.color.BallsColorsThreeStatesJCheckBox;
import jugglemasterpro.control.color.ColorActions;
import jugglemasterpro.control.color.ColorChooserDropDownJButton;
import jugglemasterpro.control.criteria.BallsNumberJCheckBox;
import jugglemasterpro.control.criteria.BallsNumberJComboBox;
import jugglemasterpro.control.criteria.FilterJLabel;
import jugglemasterpro.control.criteria.FiltersJButton;
import jugglemasterpro.control.criteria.FiltersJDialog;
import jugglemasterpro.control.criteria.FiltersJMenuItem;
import jugglemasterpro.control.criteria.FindJDialog;
import jugglemasterpro.control.criteria.FindJMenuItem;
import jugglemasterpro.control.criteria.InvalidPatternsJCheckBox;
import jugglemasterpro.control.criteria.InvalidPatternsJLabel;
import jugglemasterpro.control.criteria.MarkJButton;
import jugglemasterpro.control.criteria.MarkJCheckBox;
import jugglemasterpro.control.criteria.MarkJComboBox;
import jugglemasterpro.control.criteria.SkillJCheckBox;
import jugglemasterpro.control.criteria.SkillJComboBox;
import jugglemasterpro.control.data.ClipboardJCheckBoxMenuItem;
import jugglemasterpro.control.data.ClipboardJDialog;
import jugglemasterpro.control.data.ConsoleJCheckBoxMenuItem;
import jugglemasterpro.control.data.ConsoleJDialog;
import jugglemasterpro.control.data.DataJCheckBoxMenuItem;
import jugglemasterpro.control.data.DataJFrame;
import jugglemasterpro.control.fx.CatchSoundsJCheckBox;
import jugglemasterpro.control.fx.FXJCheckBox;
import jugglemasterpro.control.fx.JugglerJScrollBar;
import jugglemasterpro.control.fx.JugglerThreeStatesJCheckBox;
import jugglemasterpro.control.fx.LightJCheckBox;
import jugglemasterpro.control.fx.MetronomeJCheckBox;
import jugglemasterpro.control.fx.MirrorJCheckBox;
import jugglemasterpro.control.fx.SoundsJCheckBox;
import jugglemasterpro.control.fx.StrobeJScrollBar;
import jugglemasterpro.control.fx.StrobeThreeStatesJCheckBox;
import jugglemasterpro.control.fx.ThrowSoundsJCheckBox;
import jugglemasterpro.control.help.AboutJMenuItem;
import jugglemasterpro.control.help.DevelopmentJMenuItem;
import jugglemasterpro.control.help.LanguageJRadioButtonMenuItem;
import jugglemasterpro.control.help.LicenceJMenuItem;
import jugglemasterpro.control.help.LinksJMenuItemActionListener;
import jugglemasterpro.control.io.ExtendedJMenu;
import jugglemasterpro.control.io.ExtendedJMenuItem;
import jugglemasterpro.control.io.ExtendedTransferHandler;
import jugglemasterpro.control.io.FileActions;
import jugglemasterpro.control.io.ImportPatternsJButton;
import jugglemasterpro.control.io.LoadFileJMenuItem;
import jugglemasterpro.control.io.NewPatternJMenuItem;
import jugglemasterpro.control.io.QuitJMenuItem;
import jugglemasterpro.control.io.RecentFilesExtendedJMenu;
import jugglemasterpro.control.io.ReloadPatternsFilesJMenuItem;
import jugglemasterpro.control.io.ScreenPlayJMenuItem;
import jugglemasterpro.control.io.ScreenShotJMenuItem;
import jugglemasterpro.control.io.WriteFileJMenuItem;
import jugglemasterpro.control.motion.DefaultsJScrollBar;
import jugglemasterpro.control.motion.DefaultsThreeStatesJCheckBox;
import jugglemasterpro.control.motion.DwellJScrollBar;
import jugglemasterpro.control.motion.FluidityJScrollBar;
import jugglemasterpro.control.motion.HeightJScrollBar;
import jugglemasterpro.control.motion.PlayPauseJButton;
import jugglemasterpro.control.motion.SpeedJScrollBar;
import jugglemasterpro.control.pattern.ObjectsJList;
import jugglemasterpro.control.pattern.PatternJLabelMouseListener;
import jugglemasterpro.control.pattern.PatternJTextField;
import jugglemasterpro.control.pattern.ReloadPatternJButton;
import jugglemasterpro.control.pattern.ReversePatternJButton;
import jugglemasterpro.control.pattern.ShortcutsJComboBox;
import jugglemasterpro.control.pref.PreferencesJDialog;
import jugglemasterpro.control.pref.PreferencesJMenuItem;
import jugglemasterpro.control.print.PrintJMenuItem;
import jugglemasterpro.control.siteswap.ImportSiteswapsJButton;
import jugglemasterpro.control.siteswap.RefreshSiteswapJButton;
import jugglemasterpro.control.siteswap.ReverseSiteswapJCheckBox;
import jugglemasterpro.control.siteswap.SiteswapJTextPane;
import jugglemasterpro.control.siteswap.SiteswapThreeStatesJCheckBox;
import jugglemasterpro.control.style.ImportStylesJButton;
import jugglemasterpro.control.style.ReverseStyleJCheckBox;
import jugglemasterpro.control.style.SortStylesJButton;
import jugglemasterpro.control.style.StyleJCheckBox;
import jugglemasterpro.control.style.StyleJComboBox;
...
import jugglemasterpro.control.window.SplashScreenJWindow;
...
final public class ControlJFrame extends JFrame implements Runnable, Comparator<Language>, UncaughtExceptionHandler {
		...
		if (this.getExtendedState() != Frame.ICONIFIED) {
			if (this.objGjuggleMasterPro.getFrame().bolGdontFocusJuggleMasterPro) {
				...
				if (!this.objGpatternJTextField.isFocusOwner() && !this.objGsiteswapJTextPane.isFocusOwner()
					&& !this.objGstyleJComboBox.isFocusOwner() && !this.objGcolorsJTextPane.isFocusOwner()
					&& !this.objGballsJScrollBar.isFocusOwner() && !this.objGjugglerJScrollBar.isFocusOwner()
					&& !this.objGheightJScrollBar.isFocusOwner() && !this.objGspeedJScrollBar.isFocusOwner()
					&& !this.objGdwellJScrollBar.isFocusOwner() && !this.objGfluidityJScrollBar.isFocusOwner()) {
	...
	final private JPanel doAddBottomWidgets() {
		...
		final ExtendedGridBagConstraints objLbottomPanelExtendedGridBagConstraints =
		...
		final ExtendedGridBagConstraints objLfiltersPanelExtendedGridBagConstraints =
		...
		final ExtendedGridBagConstraints objLskillPanelExtendedGridBagConstraints =
																					new ExtendedGridBagConstraints(	0,
																													0,
																													1,
																													1,
		...
		final ExtendedGridBagConstraints objLmarkPanelExtendedGridBagConstraints =
																					new ExtendedGridBagConstraints(	0,
																													0,
																													1,
																													1,
		...
		final ExtendedGridBagConstraints objLshortcutsPanelExtendedGridBagConstraints =
																						new ExtendedGridBagConstraints(	GridBagConstraints.RELATIVE,
																														0,
																														1,
																														1,
	...
	final private void doAddTopMiddleWidgets() {
		...
		// Textfield zones :
		final ExtendedGridBagConstraints objLtopTextFieldsPanelsExtendedGridBagConstraints =
		...
		// Start help message :
		this.objGtopJLayeredPane.add(this.objGstartJPanel, new ExtendedGridBagConstraints(	0,
																							0,
																							7,
																							3,
																							GridBagConstraints.CENTER,
	...
	final private void doAddTopRightWidgets() {
		...
		final ExtendedGridBagConstraints objLtopRightPanelCheckBoxesExtendedGridBagConstraints =
																									new ExtendedGridBagConstraints(	7,
																																	GridBagConstraints.RELATIVE,
																																	1,
																																	1);
	...
	final private void doAddTopScrollBars() {
		...
		// Ball left-scrollbar :
		final ExtendedGridBagConstraints objLtopScrollBarsPanelsExtendedGridBagConstraints =
																								new ExtendedGridBagConstraints(	2,
																																3,
																																1,
																																1,
		...
		this.objGtopJLayeredPane.add(objLtopPanelMiddleSoundsJPanel, new ExtendedGridBagConstraints(2,
																									6,
																									5,
																									1,
																									GridBagConstraints.CENTER,
	...
	final private void doAddWidgets() {
		...
		final ExtendedGridBagConstraints objLmainPanelExtendedGridBagConstraints =
																					new ExtendedGridBagConstraints(	0,
																													0,
																													1,
																													1,
	...
	final private void doCreateEditionMenu() {
		...
		this.objGreloadPatternJuggleJMenuItem =
												new ExtendedJMenuItem(	this,
		...
		this.objGsimpleCopyJuggleJMenuItem =
												new ExtendedJMenuItem(	this,
		...
		this.objGdetailedCopyJuggleJMenuItem =
												new ExtendedJMenuItem(	this,
		...
		this.objGfreeClipboardJuggleJMenuItem =
												new ExtendedJMenuItem(	this,
	...
	private void doCreateFileMenu() {
		...
		// New file menu item :
		this.objGnewPatternsFileJMenuItem =
											new WriteFileJMenuItem(	this,
	...
	final private void doCreateHelpMenu(int intPlanguagesNumber) {
		...
		this.objGsiteswapJuggleJMenuItem =
											new ExtendedJMenuItem(	this,
		...
		this.objGnewLanguageJMenuItem =
										new WriteFileJMenuItem(this, WriteFileJMenuItem.bytS_NEW_LANGUAGE_FILE, Constants.intS_FILE_ICON_NEW_LANGUAGE);
		this.objGexportCurrentLanguageJMenuItem =
													new WriteFileJMenuItem(	this,
	...
	final private void doCreateWidgets() {
		...
		this.objGglobalMarkJButton =
										new MarkJButton(this,
														true,
														false,
		...
		this.objGobjectsJListJScrollPane =
											new JScrollPane(this.objGobjectsJList,
	...
	final private int doLoadJuggleLanguages() {
		...
		final BufferedReader objLlanguagesConfigBufferedReader =
																	Tools.getBufferedReader(Strings.doConcat(	this.objGjuggleMasterPro.strS_CODE_BASE,
																												Constants.strS_FILE_NAME_A[Constants.intS_FILE_FOLDER_DATA],
																												this.objGjuggleMasterPro.chrGpathSeparator,
		...
		if (intLlanguagesNumber == 0) {
			...
			for (int intLlanguageIndex = 0; intLlanguageIndex < intLlanguagesNumber; ++intLlanguageIndex) {
				...
				final BufferedReader objLlanguageBufferedReader =
																	Tools.getBufferedReader(Strings.doConcat(	strLfilePath,
																												Constants.strS_FILE_NAME_A[Constants.intS_FILE_TEXT_LANGUAGE]));
				final BufferedReader objLjMHeaderBufferedReader =
																	Tools.getBufferedReader(Strings.doConcat(	strLfilePath,
																												Constants.strS_FILE_NAME_A[Constants.intS_FILE_ICON_JM_HEADER]));
				final BufferedReader objLjMPHeaderBufferedReader =
																	Tools.getBufferedReader(Strings.doConcat(	strLfilePath,
																												Constants.strS_FILE_NAME_A[Constants.intS_FILE_ICON_JMP_HEADER]));
				final BufferedReader objLjAPHeaderBufferedReader =
																	Tools.getBufferedReader(Strings.doConcat(	strLfilePath,
																												Constants.strS_FILE_NAME_A[Constants.intS_FILE_ICON_JAP_HEADER]));

				this.objGlanguageA[intLlanguageIndex] =
														new Language(	strLlanguageAL.get(intLlanguageIndex),
	...
	final public boolean hasStringControlChanged(byte bytPcontrolType) {
		return !Strings	.getRightTrimmedString(this.getLanguage().getTranslatedTokensString(this.getControlString(	bytPcontrolType,
	...
	final public void setBallsControls() {
		...
		this.objGballsThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(	objLstateValue == ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																																								? Constants.bytS_BOOLEAN_LOCAL_CURRENT_THROWS
																																								: Constants.bytS_BOOLEAN_LOCAL_BALLS,
																						objLstateValue == ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																																								? Language.intS_CHECKBOX_BALLS_AND_CURRENT_THROWS
																																								: Language.intS_CHECKBOX_BALLS,
																						bolLedition));
		this.objGballsThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_CURRENT_THROWS)
																														? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																														: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_BALLS)
																																													? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
	...
	final public void setColorsControls() {
		...
		this.objGcolorsThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_COLORS)
																														? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																														: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_COLORS)
																																														? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
																																														: ThreeStatesButtonModel.bolS_UNSELECTED_BOOLEAN);
		this.objGcolorsThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(	this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_COLORS)
																																							? Constants.bytS_BOOLEAN_LOCAL_RANDOM_COLORS
																																							: Constants.bytS_BOOLEAN_LOCAL_COLORS,
																						this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_COLORS)
																																							? Language.intS_CHECKBOX_RANDOM_COLORS
		...
		final byte bytLcolorsStringType =
											this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_REVERSE_SITESWAP)
																													? Constants.bytS_STRING_LOCAL_REVERSE_COLORS
																													: Constants.bytS_STRING_LOCAL_COLORS;
		...
		final byte bytLstringSiteswapIndex =
												this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_LIGHT)
																											? Constants.bytS_STRING_LOCAL_SITESWAP_DAY
		...
		final byte bytLstringJugglerIndex =
											this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_LIGHT) ? Constants.bytS_STRING_LOCAL_JUGGLER_DAY
		...
		final byte bytLstringBackgroundIndex =
												this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_LIGHT)
	...
	final public void setDefaultsControls() {
		...
		this.objGdefaultsThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS)
																															? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																															: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_DEFAULTS)
																																															? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
																																															: ThreeStatesButtonModel.bolS_UNSELECTED_BOOLEAN);
		this.objGdefaultsThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS)
																																							? Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS
																																							: Constants.bytS_BOOLEAN_LOCAL_DEFAULTS,
																						this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS)
																																							? Language.intS_CHECKBOX_RELATIVE_DEFAULTS
	...
	final public void setFluidityControls() {
		...
		final boolean bolLfluidity =
										this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_FLUIDITY)
											|| this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_EDITION);
		...
		this.objGfluidityValueJLabel.setText(this.getControlLabelString(Strings.doConcat(bytLfluidityValue < 10 ? '0' : null, bytLfluidityValue, " %"),
																		bolLfluidityLocal,
																		bolLfluidity,
	...
	final public void setJButtonsEnabled(boolean bolPenabled) {
		...
		final boolean bolLeditionAndPatternOrStyleFound =
															bolPenabled
																&& objLpatternsManager.getPatternBooleanValue(	this.objGjuggleMasterPro.intGobjectIndex,
																												Constants.bytS_BOOLEAN_LOCAL_EDITION,
																												Constants.bytS_UNCLASS_INITIAL)
																&& (this.intGfilteredPatternsNumber > 0 || objLpatternsManager.getPatternsFileManager().bolGstyleFound);
	...
	final public void setJugglerControls() {
		...
		this.objGjugglerValueJLabel.setText(this.getByteControlLabelString(	this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_LIGHT)
		...
		this.objGjugglerThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(	this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_JUGGLER_TRAIL)
																																							? Constants.bytS_BOOLEAN_LOCAL_JUGGLER_TRAIL
																																							: Constants.bytS_BOOLEAN_LOCAL_JUGGLER,
																						this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_JUGGLER_TRAIL)
																																							? Language.intS_CHECKBOX_JUGGLER_TRAIL
																																							: Language.intS_CHECKBOX_JUGGLER,
																						bolLedition));
		this.objGjugglerThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_JUGGLER_TRAIL)
																														? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																														: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_JUGGLER)
																																														? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
																																														: ThreeStatesButtonModel.bolS_UNSELECTED_BOOLEAN);
	...
	final public void setMenusEnabled() {
		...
		final boolean bolLedition =
									(objLpatternsManager.getPatternBooleanValue(this.objGjuggleMasterPro.intGobjectIndex,
																				Constants.bytS_BOOLEAN_LOCAL_EDITION));
		final boolean bolLeditionAndPatternOrStyleFound =
															(bolLedition && (this.intGfilteredPatternsNumber > 0 || objLpatternsManager.getPatternsFileManager().bolGstyleFound));

		// Pattern menu :
		if (this.objGjuggleMasterPro.bolGprogramTrusted) {
			this.objGimportExtendedJMenu.setEnabled((objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_FILES_PATTERNS || objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_NEW_PATTERN));
			this.objGimportStylesJMenuItem.setEnabled((objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_FILES_PATTERNS || objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_NEW_PATTERN));
	...
	final public void setPatternControls() {
		...
		final String strLcurrentPattern =
											this.getLanguage()
	...
	final public void setSiteswapControls() {
		...
		final boolean bolLrefreshSiteswap =
											this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_EDITION)
												...
												&& (!this.objGjuggleMasterPro.objGsiteswap	.toString()
																							.equals(this.getControlString(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_REVERSE_SITESWAP)
																																																? Constants.bytS_STRING_LOCAL_REVERSE_SITESWAP
																																																: Constants.bytS_STRING_LOCAL_SITESWAP)) || this.objGjuggleMasterPro.objGsiteswap.bolGsymmetric);

		// Siteswap checkbox :
		this.objGsiteswapThreeStatesJCheckBox.setEnabled(bolLedition);
		this.objGsiteswapThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS)
																															? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																															: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_SITESWAP)
																																															? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
																																															: ThreeStatesButtonModel.bolS_UNSELECTED_BOOLEAN);
		final byte bytLcontrolType =
										this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS)
																											? Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS
		...
		this.objGsiteswapThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(bytLcontrolType,
																						bytLcontrolType == Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS
																																						? Language.intS_CHECKBOX_SITESWAP_AND_THROWS_VALUES
		...
		try {
			this.objGsiteswapJTextPane.selectText(bolLedition
																? this.getControlString(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_REVERSE_SITESWAP)
																																								? Constants.bytS_STRING_LOCAL_REVERSE_SITESWAP
	...
	final public void setSpeedControls() {
		...
		final boolean bolLspeed =
									this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_SPEED)
										|| this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_EDITION);
	...
	final public void setStrobeControls() {
		...
		final String strLstrobeValue =
										bytLstrobe == Constants.bytS_BYTE_LOCAL_STROBE_EACH_COUNT
																									? "   /T"
																									: bytLstrobe == Constants.bytS_BYTE_LOCAL_STROBE_EACH_CATCH
																																								? "    \370"
																																								: Strings.doConcat(	'/',
																																													bytLstrobe);

		final boolean bolLflashOrRobot =
											bolLedition
												&& (this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_FLASH) || this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_ROBOT))
												&& !this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_FX);
		this.objGstrobeValueJLabel.setEnabled(bolLflashOrRobot);
		this.objGstrobeValueJLabel.setText(this.getByteControlLabelString(Constants.bytS_BYTE_LOCAL_STROBE, strLstrobeValue, false, bolLflashOrRobot));
		...
		this.objGstrobeThreeStatesJCheckBox.select(this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_FLASH)
																												? ThreeStatesButtonModel.bolS_STRONGLY_SELECTED_BOOLEAN
																												: this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_ROBOT)
																																											? ThreeStatesButtonModel.bolS_SELECTED_BOOLEAN
																																											: ThreeStatesButtonModel.bolS_UNSELECTED_BOOLEAN);
		final byte bytLcontrolType =
										this.isControlSelected(Constants.bytS_BOOLEAN_LOCAL_FLASH) ? Constants.bytS_BOOLEAN_LOCAL_FLASH
		...
		this.objGstrobeThreeStatesJCheckBox.setText(this.getBooleanControlLabelString(	bytLcontrolType,
																						bytLcontrolType == Constants.bytS_BOOLEAN_LOCAL_FLASH
																																				? Language.intS_CHECKBOX_ROBOT_AND_FLASH
	...
	final public void setStyleControls() {
		...
		final boolean bolLeditionAndPatternOrStyle =
														bolLedition
															&& (this.intGfilteredPatternsNumber > 0 || objLpatternsManager.getPatternsFileManager().bolGstyleFound);
	...
	final public void setTitles() {
		...
		this.setTitle(MenusTools.getNoMnemonicLabel(Strings.doConcat(	"\242 ",
																		objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_NO_PATTERN
																			|| objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_FILES_PATTERNS
																																									? objLpatternsManager	.getPatternsFileManager()
																																															.getTitlesString()
																																									: objLpatternsManager.bytGpatternsManagerType == Constants.bytS_MANAGER_NEW_PATTERN
																																																														? this.getLanguageString(Language.intS_TITLE_NEW_PATTERN_FILE)
																																																														: this.getLanguageString(Language.intS_TITLE_CONSOLE),
																		" - ",
		...
		try {
			final String strLpatternName =
											Strings.doConcat(	this.getLanguage()
																	.getTranslatedTokensString(	this.getControlString(Constants.bytS_STRING_LOCAL_PATTERN),
																								objLpatternsManager.bytGpatternsManagerType),
																objLpatternsManager.hasPatternChanged(this.objGjuggleMasterPro.intGobjectIndex)
																																				? Strings.strS_RIGHT_ASTERIX
																																				: null);

			this.objGjuggleMasterPro.getFrame()
									.setTitle(Strings.doConcat(	"\370 ",
																strLpatternName.trim().length() > 0
																									? strLpatternName
																									: this.getLanguageString(Language.intS_TITLE_VISUAL),
																" - ",
																this.getLanguageString(Language.intS_TITLE_JUGGLE_MASTER_PRO)));
		} catch (final Throwable objPthrowable) {
			this.objGjuggleMasterPro.getFrame().setTitle(Strings.doConcat(	"\370 ",
																			this.getLanguageString(Language.intS_TITLE_VISUAL),
																			" - ",
																			this.getLanguageString(Language.intS_TITLE_JUGGLE_MASTER_PRO)));
		}
	...
	final public void setWindowBounds(Window objPwindow, int intPwidth, int intPheight, Window objPparentWindow, boolean bolPrightJustified) {
		...
		final int intLparentFrameWidth =
											objPparentWindow != null ? (int) objPparentWindow.getSize().getWidth() : this.getWidth()
																														+ this	.getJuggleMasterPro()
																																.getFrame()
																																.getWidth();
		final int intLparentFrameHeight = objPparentWindow != null ? objPparentWindow.getHeight() : this.getHeight();

		objPwindow.setBounds(	Math.max(Constants.intS_GRAPHICS_SCREEN_X, Math.min(intLparentFrameX + (intLparentFrameWidth - intLwidth) / 2,
																					(bolPrightJustified ? intLparentFrameX + intLparentFrameWidth
																										: Constants.intS_GRAPHICS_SCREEN_X
																											+ Constants.intS_GRAPHICS_SCREEN_WIDTH)
																						- intLwidth)),
								Math.max(Constants.intS_GRAPHICS_SCREEN_Y, Math.min(intLparentFrameY + (intLparentFrameHeight - intLheight) / 2,
