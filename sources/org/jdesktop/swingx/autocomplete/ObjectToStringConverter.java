 ...
 * </p>
 * <p>
 * A class inherited from this class could be used, when the object's <tt>toString</tt> method is not appropriate for automatic completion.
 * </p>
 * <p>
 * An example for i18n:
 * </p>
 ...
 * </p>
 * <p>
 * It's also possible to return more than one string representation. The following example shows a converter that will allow a user to choose an airport using either the airport's full description (<tt>toString()</tt>) or its ICAO/IATA code:
 * </p>
 * <p>
 * 
 * <pre>
 ...
 */
@SuppressWarnings("synthetic-access") public abstract class ObjectToStringConverter {
	...
	private static class DefaultObjectToStringConverter extends ObjectToStringConverter {
		...
		@Override public String getPreferredStringForItem(Object item) {
