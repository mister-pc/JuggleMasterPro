...
public class ListAdaptor extends AbstractAutoCompleteAdaptor implements ListSelectionListener {
	 ...
	 *            completion
	 */
	public ListAdaptor(JList list1, JTextComponent textComponent1) {
		this(list1, textComponent1, ObjectToStringConverter.DEFAULT_IMPLEMENTATION);
	}
	 ...
	 */
	public ListAdaptor(JList list1, JTextComponent textComponent1, ObjectToStringConverter stringConverter1) {
		this.list = list1;
		this.textComponent = textComponent1;
		this.stringConverter = stringConverter1;
