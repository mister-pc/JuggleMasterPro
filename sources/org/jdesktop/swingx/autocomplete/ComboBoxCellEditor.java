...
/**
 * <p>
 * This is a cell editor that can be used when a combo box (that has been set up for automatic completion) is to be used in a JTable. The {@link javax.swing.DefaultCellEditor DefaultCellEditor} won't work in this case, because each time an item gets selected it stops cell editing and hides the combo box.
 * </p>
 * <p>
 * Usage example:
 * </p>
...
public class ComboBoxCellEditor extends AbstractCellEditor implements TableCellEditor {
	 ...
	 */
	public ComboBoxCellEditor(final JComboBox comboBox1) {
		...
		final JComponent editorComponent = (JComponent) comboBox1.getEditor().getEditorComponent();
		...
		comboBox1.addPropertyChangeListener(handler);
	}
	 ...
	 * @param value
	 *            the value of the cell to be edited; null is a valid value
	 * @param isSelected
	 *            will be ignored
	 * @param row
	...
	class Handler extends KeyAdapter implements PropertyChangeListener {
		...
		public void propertyChange(PropertyChangeEvent e) {
			if (e.getPropertyName().equals("editor")) {
				final ComboBoxEditor editor = ComboBoxCellEditor.this.comboBox.getEditor();
				if (editor != null && editor.getEditorComponent() != null) {
					final JComponent editorComponent = (JComponent) ComboBoxCellEditor.this.comboBox.getEditor().getEditorComponent();
