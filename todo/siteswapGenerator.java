...
public class siteswapGenerator extends Generator {
    ...
    public void initGenerator(String[] args) throws JuggleExceptionUser {
            ...
            if (i != (argc - 1))
                ...
                if ((i < (args.length - 1)) && (args[i + 1].charAt(0) != '-')) {
                    try {
                        ...
                        throw new JuggleExceptionUser(errorstrings.getString("Error_number_format_prefix")+
                                " '"+guistrings.getString("simultaneous_throws")+"' "+errorstrings.getString("Error_number_format_suffix"));
                    }
                    i++;
                }
            }
                ...
                if ((i < (args.length - 1)) && (args[i + 1].charAt(0) != '-')) {
                    try {
                        ...
                        throw new JuggleExceptionUser(errorstrings.getString("Error_number_format_prefix")+
                                                      " '"+guistrings.getString("Jugglers")+"' "+errorstrings.getString("Error_number_format_suffix"));
                    }
                    i++;
                }
            }
        ...
        try {
            ...
            throw new JuggleExceptionUser(errorstrings.getString("Error_number_format_prefix")+
                                          " '"+guistrings.getString("balls")+"' "+errorstrings.getString("Error_number_format_suffix"));
        }
        try {
            ...
            throw new JuggleExceptionUser(errorstrings.getString("Error_number_format_prefix")+
                                          " '"+guistrings.getString("max._throw")+"' "+errorstrings.getString("Error_number_format_suffix"));
        }
        try {
			if (args[2].equals("-")) {
				llow = rhythm_period;
            ...
            throw new JuggleExceptionUser(errorstrings.getString("Error_number_format_prefix")+
                                          " '"+guistrings.getString("period")+"' "+errorstrings.getString("Error_number_format_suffix"));
        }
        ...
        if (max_time > 0.0) {
            if (loop_counter++ > loop_counter_max) {
                ...
                if ((System.currentTimeMillis() - start_time_millis) > max_time_millis)
                    throw new JuggleExceptionDone(guistrings.getString("Generator_timeout_prefix")+
                                " "+max_time+" "+guistrings.getString("Generator_timeout_suffix"));
            }
        }
        ...
        if (pos == l) {
            if ((compare_states(pattern_state[0], pattern_state[l]) == 0) && valid_pattern()) {
                if (numflag != 2)
                    print_pattern();
                if (num++ == max_num)
                    throw new JuggleExceptionDone(guistrings.getString("Generator_spacelimit_prefix")+
                                " "+max_num+" "+guistrings.getString("Generator_spacelimit_suffix"));
            }
...
class siteswapGeneratorControl extends JPanel {
    ...
    public siteswapGeneratorControl() {
        ...
        p6.add(lab14);
        gb.setConstraints(lab14, make_constraints(GridBagConstraints.WEST,0,0));
        c1 = new JComboBox();
        for (int i = 1; i <= 6; i++)
            c1.addItem(Integer.toString(i)+"   ");
        p6.add(c1);
        gb.setConstraints(c1, make_constraints(GridBagConstraints.WEST,0,1,
                                               new Insets(0,10,0,0)));
        JLabel lab9 = new JLabel(guistrings.getString("Rhythm")+":");
        p6.add(lab9);
        gb.setConstraints(lab9, make_constraints(GridBagConstraints.WEST,0,2,
                                                 new Insets(8,0,0,0)));
        ButtonGroup bg1 = new ButtonGroup();
        cb1 = new JRadioButton(guistrings.getString("asynch"));
        bg1.add(cb1);
        p6.add(cb1);
        gb.setConstraints(cb1, make_constraints(GridBagConstraints.WEST,0,3,
                                                new Insets(0,10,0,0)));
        cb2 = new JRadioButton(guistrings.getString("synch"));
        bg1.add(cb2);
        p6.add(cb2);
        gb.setConstraints(cb2, make_constraints(GridBagConstraints.WEST,0,4,
                                                new Insets(0,10,0,0)));
        /*
         cb3 = new JRadioButton("passing");
         bg1.add(cb3);
         p6.add(cb3);
         gb.setConstraints(cb3, make_constraints(GridBagConstraints.WEST,0,5,
                                                 new Insets(0,10,0,0)));
         */
        ...
        p7.add(lab10);
        gb.setConstraints(lab10, make_constraints(GridBagConstraints.WEST,0,0,
                                                  new Insets(5,0,0,0)));
        ButtonGroup bg2 = new ButtonGroup();
        cb5 = new JRadioButton(guistrings.getString("all"));
        bg2.add(cb5);
        p7.add(cb5);
        gb.setConstraints(cb5, make_constraints(GridBagConstraints.WEST,0,1,
                                                new Insets(0,10,0,0)));
        cb4 = new JRadioButton(guistrings.getString("non-obvious"));
        bg2.add(cb4);
        p7.add(cb4);
        gb.setConstraints(cb4, make_constraints(GridBagConstraints.WEST,0,2,
                                                new Insets(0,10,0,0)));
        cb6 = new JRadioButton(guistrings.getString("none_(prime_only)"));
        bg2.add(cb6);
        p7.add(cb6);
        gb.setConstraints(cb6, make_constraints(GridBagConstraints.WEST,0,3,
                                                new Insets(0,10,0,0)));
        ...
        p8.add(cb10);
        gb.setConstraints(cb10, make_constraints(GridBagConstraints.WEST,0,4,
                                                 new Insets(0,10,0,0)));
        cb17 = new JCheckBox(guistrings.getString("juggler_permutations"), null);
        p8.add(cb17);
        gb.setConstraints(cb17, make_constraints(GridBagConstraints.WEST,0,5,
                                                 new Insets(0,10,0,0)));
        cb15 = new JCheckBox(guistrings.getString("connected_patterns"), null);
        p8.add(cb15);
        gb.setConstraints(cb15, make_constraints(GridBagConstraints.WEST,0,6,
                                                 new Insets(0,10,0,0)));
        ...
        p9.add(lab12);
        gb.setConstraints(lab12, make_constraints(GridBagConstraints.WEST,0,0,
                                                  new Insets(5,0,0,0)));
        cb12 = new JCheckBox(guistrings.getString("enable"), null);
        p9.add(cb12);
        gb.setConstraints(cb12, make_constraints(GridBagConstraints.WEST,0,1,
                                                 new Insets(0,10,0,0)));
        ...
        p9.add(p3);
        gb.setConstraints(p3, make_constraints(GridBagConstraints.WEST,0,2,
                                               new Insets(0,10,0,0)));

        cb13 = new JCheckBox(guistrings.getString("no_simultaneous_catches"), null);
        p9.add(cb13);
        gb.setConstraints(cb13, make_constraints(GridBagConstraints.WEST,0,3,
                                                 new Insets(0,10,0,0)));

        cb14 = new JCheckBox(guistrings.getString("no_clustered_throws"), null);
        p9.add(cb14);
        gb.setConstraints(cb14, make_constraints(GridBagConstraints.WEST,0,4,
                                                 new Insets(0,10,0,0)));
												 
        cb16 = new JCheckBox(guistrings.getString("true_multiplexing"), null);
        p9.add(cb16);
        gb.setConstraints(cb16, make_constraints(GridBagConstraints.WEST,0,5,
                                                 new Insets(0,10,0,0)));

        JPanel p4 = new JPanel();		// whole middle part of window
        p4.setLayout(gb);
        p4.add(p6);
        gb.setConstraints(p6, make_constraints(GridBagConstraints.NORTHWEST,0,0));
        p4.add(p7);
        gb.setConstraints(p7, make_constraints(GridBagConstraints.NORTHWEST,0,1));
        p4.add(p8);
        gb.setConstraints(p8, make_constraints(GridBagConstraints.NORTHWEST,1,0));
        p4.add(p9);
        gb.setConstraints(p9, make_constraints(GridBagConstraints.NORTHWEST,1,1));
		...
		*/
        ...
        p1.add(tf7);
        gb.setConstraints(tf7, make_constraints(GridBagConstraints.EAST,0,2,
                                                new Insets(3,0,0,0)));
        /*
		...
		*/
        ...
        p1.add(lab4);
        gb.setConstraints(lab4, make_constraints(GridBagConstraints.WEST,1,2,
                                                 new Insets(3,3,0,0)));
        /*
