...
package fr.jugglemaster.pattern;
...
import fr.jugglemaster.pattern.io.PatternsFile;
import fr.jugglemaster.pattern.io.PatternsFilesManager;
...
final public class PatternsManager implements Comparator<Object> {
	...
	@Override public final int compare(Object objPfirstParameterObject, Object objPsecondParameterObject) {
		...
		for (byte bytLparameterIndex = 0; bytLparameterIndex < 2; ++bytLparameterIndex) {
			for (byte bytLvalueType = bytL_LOCAL; (bytLvalueType < bytL_VALUE)
													&& (bytLparameterValueType[bytLparameterIndex] == bytL_VALUE); ++bytLvalueType) {
		...
		// Compare values :
		return ((bytLparameterValueType[0] < bytLparameterValueType[1])	? -1
																		: (bytLparameterValueType[0] > bytLparameterValueType[1])	? 1
																																	: (bytLparameterValueType[0] < bytL_VALUE)	? 0
	...
	final private void doCreateJMPatternManager() {
		...
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_RELATIVE_SPEED][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_RELATIVE_SPEED_DEFAULT_VALUE;
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_ALTERNATE_COLORS][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_ALTERNATE_COLORS_EACH_CATCH;
		...
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_NIGHT][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_PHANTOM;
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_DAY][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_PHANTOM;
		...
		// Create JM style :
		@SuppressWarnings("unused") final byte[] bytLjMA = Constants.bytS_ENGINE_COORDONATES_NUMBER == 4	? new byte[] {	-1, 6, 0, 0, -1, 6, 0, 0, 17,
																														6, 0, 0, 17, 6, 0, 0, -1, 6,
																														0, 0, -1, 6, 0, 0, 17, 6, 0,
																														0, 7, 6, 0, 0, -1, 6, 0, 0,
																														-1, 6, 0, 0, 7, 6, 0, 0, 7, 6,
																														...
																														8, 6, 0, 0, 8, 6, 0, 0, 7, 6,
																														0, 0, 7, 6, 0, 0, 8, 6, 0, 0,
																														8, 6, 0, 0, 7, 6, 0, 0, 17, 6,
																														0, 0 }
																											: new byte[] {	-1, 6, 0, -1, 6, 0, 17, 6,
																															0, 17, 6, 0, -1, 6, 0, -1,
																															6, 0, 17, 6, 0, 7, 6, 0,
																															-1, 6, 0, -1, 6, 0, 7, 6,
																															0, 7, 6, 0, -1, 6, 0, -1,
		...
		final Style objLjMJuggleStyle = new Style(	this.strGglobalAA[Constants.bytS_STRING_LOCAL_STYLE][Constants.bytS_UNCLASS_INITIAL],
													bytLjMA,
													(byte) 0,
													bolLjMZOrderA,
													bolLjMZOrderA,
	...
	final private void doCreateNewLanguagePatternsManager() {
		...
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_RELATIVE_SPEED][Constants.bytS_UNCLASS_CURRENT] = Constants.bytS_BYTE_LOCAL_RELATIVE_SPEED_MAXIMUM_VALUE;
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_NIGHT][Constants.bytS_UNCLASS_CURRENT] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_ALL;
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_DAY][Constants.bytS_UNCLASS_CURRENT] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_ALL;
		...
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_BALLS_TRAIL][Constants.bytS_UNCLASS_CURRENT] = (byte) (Constants.bytS_BYTE_LOCAL_BALLS_TRAIL_FULL
																												- 1);
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_ALTERNATE_COLORS][Constants.bytS_UNCLASS_CURRENT] = Constants.bytS_BYTE_LOCAL_ALTERNATE_COLORS_EACH_COUNT;
		...
		this.strGglobalAA[Constants.bytS_STRING_LOCAL_JUGGLER_NIGHT][Constants.bytS_UNCLASS_CURRENT] = Constants.strS_STRING_LOCAL_JUGGLER_NIGHT_DEFAULT;
		...
		this.strGglobalAA[Constants.bytS_STRING_LOCAL_BACKGROUND_NIGHT][Constants.bytS_UNCLASS_CURRENT] =
																										Constants.strS_STRING_LOCAL_BACKGROUND_NIGHT_DEFAULT;
		this.strGglobalAA[Constants.bytS_STRING_LOCAL_BACKGROUND_DAY][Constants.bytS_UNCLASS_CURRENT] = Constants.strS_STRING_LOCAL_BACKGROUND_DAY_DEFAULT;
		...
		this.strGglobalAA[Constants.bytS_STRING_LOCAL_SITESWAP_NIGHT][Constants.bytS_UNCLASS_CURRENT] = Constants.strS_STRING_LOCAL_SITESWAP_NIGHT_DEFAULT;
	...
	final private void doCreateNewPatternManager() {
		...
		this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_CURRENT_THROWS][Constants.bytS_UNCLASS_INITIAL] =
																											this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = true;
		this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_REVERSE_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_REVERSE_STYLE][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_ALTERNATE_COLORS][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS][Constants.bytS_UNCLASS_INITIAL] = false;
		this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_EDITION][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SPEED][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_FLUIDITY][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_STYLE][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_LIGHT][Constants.bytS_UNCLASS_INITIAL] =
																																																																																																																							this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_JUGGLER][Constants.bytS_UNCLASS_INITIAL] = true;
		this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_FX][Constants.bytS_UNCLASS_INITIAL] =
																								this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_FLASH][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_ROBOT][Constants.bytS_UNCLASS_INITIAL] =
																																																																						this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_DEFAULTS][Constants.bytS_UNCLASS_INITIAL] = false;
		...
		// Set initial byte control values :
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_NIGHT][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_PHANTOM;
		this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_DAY][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_ALL;
		...
		// Set initial string control values :
		this.strGglobalAA[Constants.bytS_STRING_LOCAL_PATTERN][Constants.bytS_UNCLASS_INITIAL] = Strings.doConcat(	MenusTools.getNoMnemonicLabel(Language.strS_TOKEN_A[Language.bytS_TOKEN_NEW_PATTERN_MENU]),
		...
		final Pattern objLnewJugglePattern = new Pattern(	this,
		...
		this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_ERRORS][Constants.bytS_UNCLASS_INITIAL] =
																									this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_WARNINGS][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_INFO][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_INFO][Constants.bytS_UNCLASS_INITIAL] = false;
	}
	...
	final public void doCreateNoPatternManager(	String strPfileName,
		...
		if (strPstyle != null) {
			...
			this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_CURRENT_THROWS][Constants.bytS_UNCLASS_INITIAL] =
																												this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = true;
			this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_REVERSE_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_REVERSE_STYLE][Constants.bytS_UNCLASS_INITIAL] = false;
			this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_EDITION][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_SPEED][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_FLUIDITY][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_STYLE][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_JUGGLER][Constants.bytS_UNCLASS_INITIAL] = true;
			this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_FX][Constants.bytS_UNCLASS_INITIAL] = false;
			this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_LIGHT][Constants.bytS_UNCLASS_INITIAL] = this.bolGglobalValueAA[Constants.bytS_BOOLEAN_LOCAL_BALLS][Constants.bytS_UNCLASS_INITIAL] =
																																																	true;
			...
			this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_DWELL][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_DWELL_DEFAULT_VALUE;
			this.bytGglobalValueAA[Constants.bytS_BYTE_LOCAL_BALLS_TRAIL][Constants.bytS_UNCLASS_INITIAL] = Constants.bytS_BYTE_LOCAL_BALLS_MINIMUM_VALUE;
			...
			this.strGglobalAA[Constants.bytS_STRING_LOCAL_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = Strings.strS_EMPTY;
			this.strGglobalAA[Constants.bytS_STRING_LOCAL_REVERSE_SITESWAP][Constants.bytS_UNCLASS_INITIAL] = Strings.strS_EMPTY;
			final Pattern objLemptyJugglePattern = new Pattern(	this,
																Constants.bytS_STATE_SITESWAP_UNKNOWN_BALLS_NUMBER,
																false,
																this.bolGglobalValueAA,
																this.bytGglobalValueAA,
		...
		if (this.isPattern(intPobjectIndex)) {
			...
			for (byte bytLcontrolType = 0; bytLcontrolType < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLcontrolType) {
				if (this.bolGbooleanIsFileDefinedA[bytLcontrolType]) {
					...
					objLpattern.bolGlocalValueAA[bytLcontrolType][Constants.bytS_UNCLASS_CURRENT] = objLpattern.bolGlocalValueAA[bytLcontrolType][Constants.bytS_UNCLASS_INITIAL];
				}
			}
			...
			for (byte bytLcontrolType = 0; bytLcontrolType < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLcontrolType) {
				if (this.bolGbyteIsFileDefinedA[bytLcontrolType]) {
					...
					objLpattern.bytGlocalValueAA[bytLcontrolType][Constants.bytS_UNCLASS_CURRENT] = objLpattern.bytGlocalValueAA[bytLcontrolType][Constants.bytS_UNCLASS_INITIAL];
				}
			}
			...
			for (byte bytLcontrolType = 0; bytLcontrolType < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLcontrolType) {
				if (this.bolGstringIsFileDefinedA[bytLcontrolType]) {
					this.strGglobalAA[bytLcontrolType][Constants.bytS_UNCLASS_CURRENT] = this.strGglobalAA[bytLcontrolType][Constants.bytS_UNCLASS_INITIAL];
					objLpattern.strGlocalAA[bytLcontrolType][Constants.bytS_UNCLASS_CURRENT] = objLpattern.strGlocalAA[bytLcontrolType][Constants.bytS_UNCLASS_INITIAL];
				}
			}
	...
	final private String getBooleanParameterDefinitionString(	int intPobjectIndex,
		...
		return strLparameter != null	? Strings.doConcat('#',
														strLparameter,
														bytPfileFormat == Constants.bytS_EXTENSION_JMP	? Strings.doConcat(	" = ",
																															bolPlocality	? this.bolGbooleanIsLocalA[bytPcontrolType]	? "local"
																																														: "global"
																																			: this.getPatternBooleanValue(	intPobjectIndex,
																																											bytPcontrolType,
																																											bytPinitialOrCurrent)	? "true"
																																																	: "false")
																										: Strings.doConcat(	'=',
																															this.getPatternBooleanValue(bolPlocality	? intPobjectIndex
																																										: Constants.bytS_UNCLASS_NO_VALUE,
																																						bytPcontrolType,
																																						bytPinitialOrCurrent)	? "1"
																																												: "0"))
										: null;
	}
	...
	final private String getByteParameterDefinitionString(	int intPobjectIndex,
		...
		return strLparameter != null	? Strings.doConcat('#',
														...
														bytPfileFormat == Constants.bytS_EXTENSION_JMP	? Strings.doConcat(	" = ",
																															bolPlocality	? this.bolGbyteIsLocalA[bytPcontrolType]	? "local"
																																													: "global"
		...
		if (this.isPattern(intPobjectIndex)) {
			...
			if (bolPstyle) {
				try {
					...
					if (bolPinitial) {
						objLstyleA[Constants.bytS_UNCLASS_INITIAL] = this.getStyle(objLpattern.strGlocalAA[Constants.bytS_STRING_LOCAL_STYLE][Constants.bytS_UNCLASS_INITIAL]);
					...
					objLstyleA[Constants.bytS_UNCLASS_CURRENT] = this.getStyle(objLpattern.strGlocalAA[Constants.bytS_STRING_LOCAL_STYLE][Constants.bytS_UNCLASS_CURRENT]);
			...
			// Control header :
			if (bolPproperties) {
				final String strLheader = Strings.doConcat(
															Strings.getFixedLengthString(	"objL<property>",
				...
				for (byte bytLstringControlIndex = 0; bytLstringControlIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLstringControlIndex) {
					objLinfoStringBuilder.append(Strings.doConcat(	Constants.strS_STRING_LOCAL,
																	...
																	((this.getPatternStringValue(	intPobjectIndex,
																									bytLstringControlIndex,
																									Constants.bytS_UNCLASS_INITIAL) != null)
																		&& !this.getPatternStringValue(	intPobjectIndex,
																										bytLstringControlIndex,
																										Constants.bytS_UNCLASS_INITIAL)
			...
			final String strLcomment = this.getPatternStringValue(	intPobjectIndex,
																	Constants.bytS_STRING_LOCAL_PATTERN,
																	Constants.bytS_UNCLASS_INITIAL);

			objLinfoStringBuilder.append(Strings.doConcat(	(strLcomment == null) ? "No pattern at the specified index (" : "Specified index pattern (",
															intPobjectIndex,
															(strLcomment == null)	? ")."
																					: Strings.doConcat(	") corresponds to this comment :",
																										Strings.strS_LINE_SEPARATOR,
																										'\'',
																										strLcomment,
																										'\'',
	...
	final public byte getJugglerValue(int intPobjectIndex, byte bytPinitialOrCurrent) {
		return this.getPatternByteValue(intPobjectIndex,
										this.getPatternBooleanValue(intPobjectIndex,
																	Constants.bytS_BOOLEAN_LOCAL_LIGHT,
																	bytPinitialOrCurrent)	? Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_DAY
	...
	final public Boolean getPatternBoolean(int intPobjectIndex, byte bytPcontrolIndex, byte bytPinitialOrCurrent) {
		...
		return bytPcontrolIndex >= 0	&& bytPcontrolIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER
				&& (bytPinitialOrCurrent == Constants.bytS_UNCLASS_INITIAL || bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)
																																			? intPobjectIndex >= 0
																																			&& intPobjectIndex < this.objGobjectA.length ? this.bolGbooleanIsLocalA[bytPcontrolIndex] && this.isPattern(intPobjectIndex) ? ((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[bytPcontrolIndex][bytPinitialOrCurrent] : this.bolGglobalValueAA[bytPcontrolIndex][bytPinitialOrCurrent] : bolLtetDeKran
																																		: false;
	}
	...
	final public Byte getPatternByte(int intPobjectIndex, byte bytPcontrolIndex, byte bytPinitialOrCurrent) {
		...
		return bytPcontrolIndex >= 0	&& bytPcontrolIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER
				&& (bytPinitialOrCurrent == Constants.bytS_UNCLASS_INITIAL || bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)
																																			? intPobjectIndex >= 0
																																			&& intPobjectIndex < this.objGobjectA.length ? (this.bolGbyteIsLocalA[bytPcontrolIndex] && this.isPattern(intPobjectIndex)) ? ((Pattern) this.objGobjectA[intPobjectIndex]).bytGlocalValueAA[bytPcontrolIndex][bytPinitialOrCurrent] : this.bytGglobalValueAA[bytPcontrolIndex][bytPinitialOrCurrent] : bytLtetDeKran
																																		: Constants.bytS_UNCLASS_NO_VALUE;
	}
	...
	final public String getPatternString(int intPobjectIndex, byte bytPcontrolIndex, byte bytPinitialOrCurrent) {
		...
		return bytPcontrolIndex >= 0	&& bytPcontrolIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER && this.objGobjectA != null
				&& (bytPinitialOrCurrent == Constants.bytS_UNCLASS_INITIAL || bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)
																																			? intPobjectIndex >= 0
																																			&& intPobjectIndex < this.objGobjectA.length ? this.isPattern(intPobjectIndex) ? this.bolGstringIsLocalA[bytPcontrolIndex] ? ((Pattern) this.objGobjectA[intPobjectIndex]).strGlocalAA[bytPcontrolIndex][bytPinitialOrCurrent] : this.strGglobalAA[bytPcontrolIndex][bytPinitialOrCurrent] : this.objGobjectA[intPobjectIndex].toString() : strLtetDeKran
																																		: Strings.strS_EMPTY;
	}
	 ...
	 * @return
	 */
	final private String getStringParameterDefinitionString(int intPobjectIndex,
															byte bytPcontrolType,
															byte bytPinitialOrCurrent,
															boolean bolPlocality) {
		final String strLparameter = Constants.strS_STRING_LOCAL_CONTROL_A[bytPcontrolType];
		return strLparameter != null	? Strings.doConcat(((bytPcontrolType == Constants.bytS_STRING_LOCAL_COLORS)
															&& !bolPlocality)	? "$ "
																				: Strings.doConcat(	'#',
	...
	final public boolean hasPatternChanged(int intPpatternIndex) {
		...
		for (byte bytLbyteValueIndex = 0; bytLbyteValueIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLbyteValueIndex) {
			if (this.bolGbyteIsLocalA[bytLbyteValueIndex]	&& this.bolGbyteIsFileDefinedA[bytLbyteValueIndex]
		...
		for (byte bytLbooleanValueIndex = 0; bytLbooleanValueIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLbooleanValueIndex) {
			if (this.bolGbooleanIsLocalA[bytLbooleanValueIndex]	&& this.bolGbooleanIsFileDefinedA[bytLbooleanValueIndex]
		...
		for (byte bytLstringValueIndex = 0; bytLstringValueIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLstringValueIndex) {
			if (this.bolGstringIsLocalA[bytLstringValueIndex]	&& this.bolGstringIsFileDefinedA[bytLstringValueIndex]
	...
	final public void initCurrentValues() {
		for (byte bytLbyteValueIndex = 0; bytLbyteValueIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLbyteValueIndex) {
			this.bytGglobalValueAA[bytLbyteValueIndex][Constants.bytS_UNCLASS_CURRENT] = this.bytGglobalValueAA[bytLbyteValueIndex][Constants.bytS_UNCLASS_INITIAL];
		}

		for (byte bytLbooleanValueIndex = 0; bytLbooleanValueIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLbooleanValueIndex) {
			this.bolGglobalValueAA[bytLbooleanValueIndex][Constants.bytS_UNCLASS_CURRENT] = this.bolGglobalValueAA[bytLbooleanValueIndex][Constants.bytS_UNCLASS_INITIAL];
		}

		for (byte bytLstringValueIndex = 0; bytLstringValueIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLstringValueIndex) {
			this.strGglobalAA[bytLstringValueIndex][Constants.bytS_UNCLASS_CURRENT] =
																					(this.strGglobalAA[bytLstringValueIndex][Constants.bytS_UNCLASS_INITIAL] != null)	? new String(this.strGglobalAA[bytLstringValueIndex][Constants.bytS_UNCLASS_INITIAL])
																																										: null;
		}
	...
	final private void setDefaultProperties() {
		...
		this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_RELATIVE_SPEED] =
																		this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_HEIGHT] =
																																this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_SKILL] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_MARK] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_DWELL] =
																																																																										true;
		this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_SPEED] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_ALTERNATE_COLORS] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_FLUIDITY] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_NIGHT] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_JUGGLER_BODY_DAY] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_DEFAULTS] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_STROBE] = this.bolGbyteIsLocalA[Constants.bytS_BYTE_LOCAL_BALLS_TRAIL] = false;
		...
		this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_SITESWAP_DAY] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_TOOLTIP] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_SITESWAP_NIGHT] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_BACKGROUND_DAY] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_BACKGROUND_NIGHT] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_JUGGLER_DAY] =
																																																																																																								this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_JUGGLER_NIGHT] = false;
		this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_PATTERN] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_COLORS] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_REVERSE_COLORS] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_STYLE] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_SITESWAP] = this.bolGstringIsLocalA[Constants.bytS_STRING_LOCAL_REVERSE_SITESWAP] = true;
		...
		if ((bytPcontrolIndex >= 0)	&& (bytPcontrolIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER)
			...
			if (bolPenabled) {
				if (bytPcontrolIndex == Constants.bytS_BOOLEAN_LOCAL_FLASH) {
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_ROBOT][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_JUGGLER][bytPinitialOrCurrent] = true;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_FLASH][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_COLORS][bytPinitialOrCurrent] = true;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_BALLS][bytPinitialOrCurrent] = true;
					}
				}
			} else {
				if (bytPcontrolIndex == Constants.bytS_BOOLEAN_LOCAL_SITESWAP) {
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_SITESWAP_THROWS][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_JUGGLER_TRAIL][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_CURRENT_THROWS][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_RANDOM_COLORS][bytPinitialOrCurrent] = false;
					}
					...
					if (bolLpattern) {
						((Pattern) this.objGobjectA[intPobjectIndex]).bolGlocalValueAA[Constants.bytS_BOOLEAN_LOCAL_RANDOM_DEFAULTS][bytPinitialOrCurrent] = false;
					}
				}
			}
		}
	...
	final public String toFileString(	byte bytPinitialOrCurrent,
		...
		final StringBuilder objLtoStringBuilder = new StringBuilder(16384
																	+ 512 * (intLfilteredObjectIndexA != null ? intLfilteredObjectIndexA.length : 0));
		...
		if (bolPsiteswaps && this.objGobjectA != null) {
			...
			if (intLfilteredObjectIndexA != null) {
				for (int intLfilteredObjectIndex = 0, intLfilteredShortcutIndex =
																				0, intLpreviousPatternIndex =
																											Constants.bytS_UNCLASS_NO_VALUE; intLfilteredObjectIndex < intLfilteredObjectIndexA.length; ++intLfilteredObjectIndex) {
					if (this.objGobjectA[intLfilteredObjectIndexA[intLfilteredObjectIndex]] instanceof String) {
						...
						bolLshortcut = ((intLfilteredShortcutIndexA != null)
										&& (intLfilteredObjectIndex == intLfilteredShortcutIndexA[intLfilteredShortcutIndex]));
						objLtoStringBuilder.append(Strings.doConcat('/',
																	bolLshortcut ? '[' : null,
																	strLcomment	.trim()
																				.length() > 0 || bytPextensionFileFormat == Constants.bytS_EXTENSION_JMP	? strLcomment
																																							: " ",
																	bolLshortcut ? ']' : null));
						intLpreviousPatternIndex = Constants.bytS_UNCLASS_NO_VALUE;
															...
															bytPinitialOrCurrent)
								&& (bytPextensionFileFormat == Constants.bytS_EXTENSION_JMP	|| !bolPstyles
									|| this	.getStyle(this.getPatternStringValue(intLfilteredObjectIndexA[intLfilteredObjectIndex],
																				Constants.bytS_STRING_LOCAL_STYLE,
																				bytPinitialOrCurrent))
											.isJMStyle())) {

						// Write pattern :
						final ArrayList<String> objLlocalParametersArrayList = new ArrayList<String>(Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER
						...
						if (bytPextensionFileFormat == Constants.bytS_EXTENSION_JMP) {
							for (byte bytLbooleanControlIndex = 0; bytLbooleanControlIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLbooleanControlIndex) {
								if ((Constants.strS_BOOLEAN_LOCAL_CONTROL_A_A[bytLbooleanControlIndex][bytPextensionFileFormat] != null)
									...
									&& (!this.isPattern(intLpreviousPatternIndex)
										|| (this.getPatternBooleanValue(intLpreviousPatternIndex,
																		bytLbooleanControlIndex,
						...
						for (byte bytLbyteControlIndex = 0; bytLbyteControlIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLbyteControlIndex) {
							if ((Constants.strS_BYTE_LOCAL_CONTROL_A_A[bytLbyteControlIndex][bytPextensionFileFormat] != null)
								...
								&& (!this.isPattern(intLpreviousPatternIndex)	|| (bytLbyteControlIndex == Constants.bytS_BYTE_LOCAL_HEIGHT)
									|| (bytLbyteControlIndex == Constants.bytS_BYTE_LOCAL_DWELL)
									|| (this.getPatternByteValue(	intLpreviousPatternIndex,
																	bytLbyteControlIndex,
						...
						if (bytPextensionFileFormat == Constants.bytS_EXTENSION_JMP) {
							for (byte bytLstringControlIndex = 0; bytLstringControlIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLstringControlIndex) {
								if ((bytLstringControlIndex != Constants.bytS_STRING_LOCAL_PATTERN)
									...
									&& (!this.isPattern(intLpreviousPatternIndex)	|| (bytLstringControlIndex == Constants.bytS_STRING_LOCAL_COLORS)
										|| ((this.getPatternStringValue(intLpreviousPatternIndex,
																		bytLstringControlIndex,
																		bytPinitialOrCurrent) != null)
											&& !this.getPatternStringValue(intLpreviousPatternIndex, bytLstringControlIndex, bytPinitialOrCurrent)
	...
	final private String toHeaderParametersString(byte bytPinitialOrCurrent, byte bytPfileExtension) {
		final ArrayList<String> strLparameterAL = new ArrayList<String>(Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER
		...
		for (byte bytLbooleanControlIndex = 0; bytLbooleanControlIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLbooleanControlIndex) {
			if (Constants.strS_BOOLEAN_LOCAL_CONTROL_A_A[bytLbooleanControlIndex][bytLcontrolStringTypeIndex] != null) {
				if (bytPfileExtension == Constants.bytS_EXTENSION_JMP
						&& (this.bolGbooleanIsFileDefinedA[bytLbooleanControlIndex]
						|| (this.bolGbooleanIsUserDefinedA[bytLbooleanControlIndex] && (bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)))
					&& !this.bolGbooleanIsLocalA[bytLbooleanControlIndex] || bytPfileExtension == Constants.bytS_EXTENSION_JM) {
					final String strLbooleanParameterDefinition = this.getBooleanParameterDefinitionString(	Constants.bytS_UNCLASS_NO_VALUE,
																											bytLbooleanControlIndex,
																											bytPfileExtension,
																											bytPinitialOrCurrent,
																											false);
		...
		for (byte bytLbyteControlIndex = 0; bytLbyteControlIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLbyteControlIndex) {
			if (Constants.strS_BYTE_LOCAL_CONTROL_A_A[bytLbyteControlIndex][bytPfileExtension] != null) {
				if (bytPfileExtension == Constants.bytS_EXTENSION_JMP
						&& (this.bolGbyteIsFileDefinedA[bytLbyteControlIndex]
						|| (this.bolGbyteIsUserDefinedA[bytLbyteControlIndex] && (bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)))
					&& !this.bolGbyteIsLocalA[bytLbyteControlIndex]
					|| bytPfileExtension == Constants.bytS_EXTENSION_JM	&& bytLbyteControlIndex != Constants.bytS_BYTE_LOCAL_HEIGHT
						&& bytLbyteControlIndex != Constants.bytS_BYTE_LOCAL_DWELL) {
					final String strLbyteParameterDefinition = this.getByteParameterDefinitionString(	Constants.bytS_UNCLASS_NO_VALUE,
																										bytLbyteControlIndex,
																										bytPfileExtension,
																										bytPinitialOrCurrent,
																										false);
		...
		if (bytPfileExtension == Constants.bytS_EXTENSION_JMP) {
			for (byte bytLstringControlIndex = 0; bytLstringControlIndex < Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER; ++bytLstringControlIndex) {
				if ((bytLstringControlIndex != Constants.bytS_STRING_LOCAL_PATTERN)
					...
					&& (bytLstringControlIndex != Constants.bytS_STRING_LOCAL_STYLE)
					&& (Constants.strS_STRING_LOCAL_CONTROL_A[bytLstringControlIndex] != null)) {
					if ((this.bolGstringIsFileDefinedA[bytLstringControlIndex]
							|| (this.bolGstringIsUserDefinedA[bytLstringControlIndex] && (bytPinitialOrCurrent == Constants.bytS_UNCLASS_CURRENT)))
						&& !this.bolGstringIsLocalA[bytLstringControlIndex]) {
		...
		if (bytPfileExtension == Constants.bytS_EXTENSION_JM && (this.bolGstringIsFileDefinedA[Constants.bytS_STRING_LOCAL_BACKGROUND_DAY]
																	|| this.bolGstringIsUserDefinedA[Constants.bytS_STRING_LOCAL_BACKGROUND_DAY])) {
		...
		final StringBuilder objLtoStringBuilder = new StringBuilder((Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER
																			+ Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER
																		+ Constants.bytS_STRING_LOCAL_CONTROLS_NUMBER)
																	* 16);
	...
	final private String toHeaderString(byte bytPfileFormat, Language objPlanguage) {
		// File header :
		StringBuilder objLtoStringBuilder = new StringBuilder(objPlanguage.getPropertyValueString(bytPfileFormat == Constants.bytS_EXTENSION_JMP	? Language.intS_MESSAGE_PATTERNS_JMP_FILE_HEADER
																																					: bytPfileFormat == Constants.bytS_EXTENSION_JM	? Language.intS_MESSAGE_PATTERNS_JM_FILE_HEADER
																																																	: bytPfileFormat == Constants.bytS_EXTENSION_JAP	? Language.intS_MESSAGE_PATTERNS_JAP_FILE_HEADER
																																																														: Constants.bytS_UNCLASS_NO_VALUE));
		...
		if (intLtitleIndex >= 0) {
			objLtoStringBuilder = new StringBuilder(Strings.doConcat(	objLtoStringBuilder.substring(0, intLtitleIndex),
																		this.getPatternsFileManager().getTitlesString(),
	...
	final public String toPatternString(int intPobjectIndex, byte bytPfileFormat, boolean bolPdetailed, Language objPlanguage) {
		...
		if (this.isPattern(intPobjectIndex)) {
			final ArrayList<String> strLparameterAL = new ArrayList<String>(bolPdetailed ? Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER
																								+ Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER
			...
			if (bolPdetailed) {
				for (byte bytLbooleanControlIndex = 0; bytLbooleanControlIndex < Constants.bytS_BOOLEAN_LOCAL_CONTROLS_NUMBER; ++bytLbooleanControlIndex) {
					if ((Constants.strS_BOOLEAN_LOCAL_CONTROL_A_A[bytLbooleanControlIndex][bytPfileFormat] != null)
						...
						final String strLbooleanParameterDefinition = this.getBooleanParameterDefinitionString(	intPobjectIndex,
																												bytLbooleanControlIndex,
																												bytPfileFormat,
																												Constants.bytS_UNCLASS_CURRENT,
																												false);
			...
			for (byte bytLbyteControlIndex = 0; bytLbyteControlIndex < Constants.bytS_BYTE_LOCAL_CONTROLS_NUMBER; ++bytLbyteControlIndex) {
				if ((Constants.strS_BYTE_LOCAL_CONTROL_A_A[bytLbyteControlIndex][bytPfileFormat] != null)
					&& (bolPdetailed	|| (bytLbyteControlIndex == Constants.bytS_BYTE_LOCAL_HEIGHT)
						|| (bytLbyteControlIndex == Constants.bytS_BYTE_LOCAL_DWELL))) {
					final String strLbyteParameterDefinition = this.getByteParameterDefinitionString(	intPobjectIndex,
																										bytLbyteControlIndex,
																										bytPfileFormat,
																										Constants.bytS_UNCLASS_CURRENT,
																										false);
