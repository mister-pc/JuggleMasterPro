...
import fr.jugglemaster.engine.util.AnimatedGIFEncoder;
import fr.jugglemaster.engine.util.ExtendedClip;
...
import fr.jugglemaster.gear.Body;
	...
	final public void initProgramProperties() {
		...
		try {
			final java.util.prefs.Preferences objLpreferences =
																java.util.prefs.Preferences.systemNodeForPackage(fr.jugglemaster.engine.JuggleMasterPro.class);
